...
function publicQuestionDto(id, data) {
  ...
  return {
    ...
    patternKey: cleanString(data && data.patternKey, 80) || "standard",
    patternVariant: cleanString(data && data.patternVariant, 120),
    shortQuestionMarks: Number.isSafeInteger(data && data.shortQuestionMarks) ? data.shortQuestionMarks : 2,
