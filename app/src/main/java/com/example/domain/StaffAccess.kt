...
object AccessControl {
    ...
    private val routePermissions = mapOf(
        ...
        "TeacherClassSessionsRoute" to setOf(StaffPermissions.MANAGE_STAFF, StaffPermissions.MANAGE_SALARY),
        ...
        "FinalExamsRoute" to setOf(StaffPermissions.MANAGE_EXAMS),
        "CreateFinalExamRoute" to setOf(StaffPermissions.MANAGE_EXAMS),
        "FinalExamDetailRoute" to setOf(StaffPermissions.MANAGE_EXAMS),
        "FinalExamMarksRoute" to setOf(StaffPermissions.MANAGE_EXAMS),
        "FinalExamResultsRoute" to setOf(StaffPermissions.MANAGE_EXAMS, StaffPermissions.VIEW_REPORTS),
