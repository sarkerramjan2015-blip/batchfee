...
$oldCall = Normalize $oldCall
$newCall = Normalize $newCall
...
Replace-Once ') { Text("Previous questions", color = BankText) }' ') { Text("Previous questions", maxLines = 1, overflow = TextOverflow.Ellipsis, fontSize = 13.sp, color = BankText) }' 'previous questions button'
...
$oldDialog = Normalize $oldDialog
$newDialog = Normalize $newDialog
